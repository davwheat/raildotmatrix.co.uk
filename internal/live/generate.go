...
//
//go:generate protoc -I ../../proto --go_out=../.. --go_opt=module=github.com/davwheat/led-departure-board --go_opt=Mdarwin/live/v2/live.proto=github.com/davwheat/led-departure-board/internal/live/pb;pb ../../proto/darwin/live/v2/live.proto
