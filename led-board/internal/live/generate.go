...
// uses are generated.
//
//go:generate protoc -I ../../proto --go-lite_out=../.. --go-lite_opt=features=marshal+unmarshal+size --go-lite_opt=module=github.com/davwheat/led-departure-board --go-lite_opt=Mdarwin/live/v2/live.proto=github.com/davwheat/led-departure-board/internal/live/pb;pb --go-lite_opt=Mgoogle/protobuf/timestamp.proto=github.com/aperturerobotics/protobuf-go-lite/types/known/timestamppb --go-lite_opt=Mgoogle/protobuf/duration.proto=github.com/aperturerobotics/protobuf-go-lite/types/known/durationpb ../../proto/darwin/live/v2/live.proto
