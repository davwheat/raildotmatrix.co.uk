...
const labels = {
  ...
  platform_position: "Platform number position",
...
const nice = {
  ...
  white: "White",
  none: "None",
  before: "Before the departure number",
  after: "After the departure number",
  matrix: "LED matrix",
  png: "PNG images",
...
const groups = [
  [
    ...
    "crs board colour platforms platform_position scroll_speed",
  ],
  [
    "Display options",
    "",
